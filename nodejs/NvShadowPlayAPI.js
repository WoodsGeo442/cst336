...
function RegisterExpressEndpoints(app, io, logger) {
    ...
    //! Gets process info
    app.get('/ShadowPlay/v.1.0/Capture/ProcessInfo', function (req, res) {
        function doReply(err, data) {
            if (err) {
                replyWithError(res, err);
            }
        ...
        try {
            api.CaptureProcessInfo(doReply);
        }
        catch (err) {
            replyWithError(res, err);
        }
    ...
    app.post('/ShadowPlay/v.1.0/Highlights', function (req, res) {
        function doReply(err, data) {
            if (err) {
                replyWithError(res, err);
            }
    ...
    app.get('/ShadowPlay/v.1.0/Highlights', function (req, res) {
        function doReply(err, data) {
            if (err) {
                replyWithError(res, err);
            }
